...
export const Timeline: FC = () => {
  return (
    <div className="relative before:absolute before:inset-0 before:ml-2 before:h-full before:w-0.5 before:-translate-x-px before:bg-gradient-to-b before:from-transparent before:via-slate-300 before:to-transparent">
      <TimelineItem title="Aperture Education" date="April 2024 - Present">
        <li>
          Currently developing a K-12 student assessment platform focusing on social and emotional learning, leveraging
          React, TypeScript, Zustand, and TanStack Query.
        </li>
      </TimelineItem>

      <TimelineItem title="CDIT" date="December 2020 - April 2024">
        <li>
          Built and architected a new mobile first dashboard, membership cart, and a live instructor-guided online
          education SaaS platform for dentist and their practices using Vue 3, TypeScript, Nuxt, and GraphQL. Extensive
          testing was done with Vitest, Vue Testing Library, and Cypress with meaningful code coverage averaging around
          80%.
        </li>
        <li>
        ...
        <li>
          Helped build a new platform in React for a VOIP SaaS and migrated modules from NPM packages to Webpack Module
          Federation to allow for a better Microfrontend architecture. This improvement helped with challenges such as
          application updates, deployments, and reduced the number of pull requests needed from 5 to 1.
        </li>
      </TimelineItem>

      <TimelineItem title="Veriforce" date="July 2017 - December 2020">
        <li>
        ...
        <li>
          Advocated for UI and code consistency by creating design patterns and managing dependency upgrades, enhancing
        ...
        <li>
          Migrated existing React projects to TypeScript which laid out the structure and configuration for future React
          projects.
        </li>
      </TimelineItem>

      <TimelineItem title="Netchex" date="November 2014 – July 2017">
        <li>
